...
class GameState:
    ...
    white_to_move : bool
        A boolean indicating if it's white's turn to move.
    move_log : list
        A list to keep track of all moves made in the game.
    white_king_location : tuple
        A tuple representing the white king's position.
    black_king_location : tuple
        A tuple representing the black king's position.
    check_mate : bool
        A boolean indicating if the game is in a checkmate state.
    stale_mate : bool
        A boolean indicating if the game is in a stalemate state.
    enpassant_possible : tuple
        A tuple representing the position where en passant is possible.
    current_castling_rights : CastleRights
        An instance of CastleRights to track castling rights.
    """
    ...
    def makeMove(self, move):
        ...
        ----------
        move : Move
            An instance of the Move class representing the move to be made.
        """
    ...
    def updateCastleRights(self, move):
        ...
        ----------
        move : Move
            An instance of the Move class representing the move made.
        """
    ...
    def getValidMoves(self):
        ...
        -------
        list
            A list of valid moves for the current game state.
        """
    ...
    def getAllPossibleMoves(self):
        """
        Generates all possible moves for the current game state without considering checks.
    ...
    def getCastleMoves(self, row, col, moves):
        ...
        ----------
        row : int
            The row position of the king.
        col : int
            The column position of the king.
        moves : list
            A list to store the generated castling moves.
        """
    ...
    def getKingsideCastleMoves(self, row, col, moves):
        """
        Generates kingside castling moves.
        ...
        col : int
            The column position of the king.
        moves : list
            A list to store the generated kingside castling moves.
        """
    ...
    def getQueensideCastleMoves(self, row, col, moves):
        """
        Generates queenside castling moves.
        ...
        col : int
            The column position of the king.
        moves : list
            A list to store the generated queenside castling moves.
        """
        if (
...
class CastleRights:
    """
    A class to represent the castling rights in a chess game.
...
class Move:
    """
    A class to represent a move in a chess game.

    Attributes:
    ----------
    start_row : int
        The row position where the move starts.
    start_col : int
        The column position where the move starts.
    end_row : int
        The row position where the move ends.
    end_col : int
        The column position where the move ends.
    piece_moved : str
